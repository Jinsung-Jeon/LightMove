...
#class _RungeKuttaState(collections.namedtuple('_RungeKuttaState', 'y1, f1, t0, t1, t2, h,dt, interp_coeff')):
...
#def _runge_kutta_step(func, y0, f0, t0,t2,h, dt, tableau):
def _runge_kutta_step(func, y0, f0, t0, dt, tableau):
    ...
    for alpha_i, beta_i in zip(tableau.alpha, tableau.beta):
        ...
        #tuple(k_.append(f_) for k_, f_ in zip(k, func(ti, yi, t2, h)))
