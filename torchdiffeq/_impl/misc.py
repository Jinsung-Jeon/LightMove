...
#def _select_initial_step(fun, t0, y0, t2, h, order, rtol, atol, f0=None):
...
#def _check_inputs(func, y0, t, t2, h):
...
#def _check_inputs(func, y0, t)
    ...
    if torch.is_tensor(y0):
        ...
        #func = lambda t, y, t2, h: (_base_nontuple_func_(t, y[0], t2, h),)
    ...
    if _decreasing(t):
        ...
        #func = lambda t, y, t2, h: tuple(-f_ for f_ in _base_reverse_func(-t, y, t2, h))
    ...
    return tensor_input, func, y0, t#, t2, h
