...
#def odeint(func, y0, t, t2, h, rtol=1e-7, atol=1e-9, method=None, options=None):
def odeint(func, y0, t, rtol=1e-7, atol=1e-9, method=None, options=None):
    ...
    #tensor_input, func, y0, t, t2, h = _check_inputs(func, y0, t, t2, h)
    ...
    #solver = SOLVERS[method](func, y0, t2, h, rtol=rtol, atol=atol, **options)
